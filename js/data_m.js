...
var M_value=[
    ...
    {pid:'8002',name:'エルダーゴブリン<br>哥布林长老', monsKind:'ゴブリン系' ,spaceName:'アステリア平原<br>バハマール高原<br><a onclick="showFuBenWhereIs(1)">巨竜の爪痕・自由探索</a><br><a onclick="showFuBenWhereIs(3)">ともし火の森・自由探索</a><br><a onclick="showFuBenWhereIs(9)">機跡の谷・自由探索</a><br><a onclick="showFuBenWhereIs(14)">滝裏の盗掘痕跡・自由探索</a>',isBoss:'小怪',mapWhere:['8035','8002','8036','8004','8167','8219'],lessElem:'土',moreElem:'火'},
    ...
    {pid:'8020',name:'リザードゴースト<br>蓝蜥蜴', monsKind:'リザード系' ,spaceName:'バハマール高原<br>エバーグリーン砂漠<br><a onclick="showFuBenWhereIs(8)">音無き都・自由探索</a><br><a onclick="showFuBenWhereIs(13)">黄砂の入り江・自由探索</a>',isBoss:'小怪',mapWhere:['8044','8045','8157','8216'],lessElem:'雷',moreElem:'火'},
    ...
    {pid:'8032',name:'デザートファング<br>大漠獠牙・幼年', monsKind:'ボア系' ,spaceName:'エバーグリーン砂漠<br><a onclick="showFuBenWhereIs(7)">風精の舞台・自由探索</a><br><a onclick="showFuBenWhereIs(13)">黄砂の入り江・自由探索</a>',isBoss:'小怪',mapWhere:['8065','8148','8212'],lessElem:'火',moreElem:'土'},
    {pid:'8033',name:'グレートファング<br>大漠獠牙・成年', monsKind:'ボア系' ,spaceName:'エバーグリーン砂漠',isBoss:'小怪',mapWhere:['8066'],lessElem:'火',moreElem:'土'},
    {pid:'8034',name:'ランドホーク<br>白羽鹞', monsKind:'ホーク系' ,spaceName:'エバーグリーン砂漠<br><a onclick="showFuBenWhereIs(13)">黄砂の入り江・自由探索</a>',isBoss:'小怪',mapWhere:['8067','8213'],lessElem:'土',moreElem:'火'},
    {pid:'8035',name:'サンドバイパー<br>白蝰蛇', monsKind:'バイパー系' ,spaceName:'エバーグリーン砂漠<br><a onclick="showFuBenWhereIs(11)">暁の虫砦・自由探索</a><br><a onclick="showFuBenWhereIs(13)">黄砂の入り江・自由探索</a>',isBoss:'小怪',mapWhere:['8068','8186','8214'],lessElem:'雷',moreElem:'土'},
    {pid:'8036',name:'シャドウバイパー<br>黑蝰蛇', monsKind:'バイパー系' ,spaceName:'エバーグリーン砂漠<br><a onclick="showFuBenWhereIs(13)">黄砂の入り江・自由探索</a>',isBoss:'小怪',mapWhere:['8069','8215'],lessElem:'土',moreElem:'冰'},
    {pid:'8037',name:'マスクモス<br>彩羽鹞', monsKind:'ホーク系' ,spaceName:'エバーグリーン砂漠<br><a onclick="showFuBenWhereIs(13)">黄砂の入り江・自由探索</a>',isBoss:'小怪',mapWhere:['8071','8213'],lessElem:'土',moreElem:'冰'},
    ...
    {pid:'8039',name:'オオカガチヤンマ<br>黄卡伽蜻蜓', monsKind:'ヤンマ系' ,spaceName:'エバーグリーン砂漠<br><a onclick="showFuBenWhereIs(6)">ボルオム遺跡・自由探索</a><br><a onclick="showFuBenWhereIs(13)">黄砂の入り江・自由探索</a>',isBoss:'小怪',mapWhere:['8073','8074','8217'],lessElem:'雷',moreElem:'冰'},
    ...
    {pid:'8043',name:'ゴブリン・グロウ<br>紫皮斧头哥布林', monsKind:'ゴブリン系' ,spaceName:'<a onclick="showFuBenWhereIs(1)">巨竜の爪痕・自由探索</a><br><a onclick="showFuBenWhereIs(14)">滝裏の盗掘痕跡・自由探索</a>',isBoss:'小怪',mapWhere:['8078','8223'],lessElem:'土',moreElem:'火'},
    ...
    {pid:'8062',name:'ゴブリンセージ<br>哥布林祭司', monsKind:'ゴブリン系' ,spaceName:'<a onclick="showFuBenWhereIs(3)">ともし火の森・自由探索</a><br><a onclick="showFuBenWhereIs(8)">音無き都・自由探索</a><br><a onclick="showFuBenWhereIs(9)">機跡の谷・自由探索</a><br><a onclick="showFuBenWhereIs(14)">滝裏の盗掘痕跡・自由探索</a>',isBoss:'小怪',mapWhere:['8133','8156','8169','8221'],lessElem:'土',moreElem:'火'},
    ...
    {pid:'8068',name:'ゴブリンファイター<br>哥布林斗士', monsKind:'ゴブリン系' ,spaceName:'<a onclick="showFuBenWhereIs(8)">音無き都・自由探索</a><br><a onclick="showFuBenWhereIs(9)">機跡の谷・自由探索</a><br><a onclick="showFuBenWhereIs(14)">滝裏の盗掘痕跡・自由探索</a>',isBoss:'小怪',mapWhere:['8156','8166','8218'],lessElem:'土',moreElem:'火'},
    ...
    {pid:'8074',name:'ゴブリンウォーロード<br>哥布林战士', monsKind:'ゴブリン系' ,spaceName:'<a onclick="showFuBenWhereIs(9)">機跡の谷・自由探索</a><br><a onclick="showFuBenWhereIs(14)">滝裏の盗掘痕跡・自由探索</a>',isBoss:'小怪',mapWhere:['8168','8220'],lessElem:'土',moreElem:'火'},
    ...
    {pid:'8100',name:'サンドリザード<br>沙蜥蜴', monsKind:'リザード系' ,spaceName:'<a onclick="showFuBenWhereIs(13)">黄砂の入り江・自由探索</a>',isBoss:'小怪',mapWhere:['8216'],lessElem:'土',moreElem:'冰'},
    {pid:'8101',name:'マスターゴブリン<br>大师哥布林', monsKind:'ゴブリン系' ,spaceName:'<a onclick="showFuBenWhereIs(14)">滝裏の盗掘痕跡・自由探索</a>',isBoss:'小怪',mapWhere:['8222'],lessElem:'土',moreElem:'火'},
    {pid:'8102',name:'*雪かぶりのボア<br>*积雪野猪', monsKind:'ボア系' ,spaceName:'アステリア平原<br>バハマール高原<br>エバーグリーン砂漠',isBoss:'小怪',mapWhere:['8226','8227','8228'],lessElem:'冰',moreElem:'火'},
]
var MB_value = [
    ...
    {pid:'8554',name:'キングゴブリン<br>哥布林王', monsKind:'ゴブリン系' ,spaceName:'<a onclick="showFuBenWhereIs(14)">滝裏の盗掘痕跡・自由探索</a>',isBoss:'Boss',mapWhere:['8225'],showTime:'讨伐附近的同类型敌人',level:'58'},
    {pid:'8555',name:'*雪化粧の獣<br>*雪化妆之兽', monsKind:'ボア系' ,spaceName:'エバーグリーン砂漠 ',isBoss:'Boss',mapWhere:['8229'],showTime:'讨伐附近的同类型敌人',level:'45'},
    {pid:'8556',name:'プリドークβ<br>', monsKind:'クアッドアーム系' ,spaceName:'<a onclick="showFuBenWhereIs(13)">黄砂の入り江・自由探索</a>',isBoss:'Boss',mapWhere:['8224'],showTime:'讨伐附近的同类型敌人',level:'60'},
]